---
title: Český rozhlas (2025) — test AI asistentů (EBU), zkreslení ve 45 %
type: zdroj
...
- **Konkrétní české příklady:** Perplexity tvrdil, že **náhradní mateřství je v ČR zakázáno**
  (ve skutečnosti **neregulováno**); ChatGPT/Copilot čerpaly z **prvnizpravy.cz** (zpravodajskou
  službou označeno za **proruský dezinformační** web); Copilot vydal názor Alexandra Vondry za
  fakt a jinde **zamlčel protinázor** z debaty.

## Kam ve wiki vstupuje
- [[halucinace-falesne-atribuce]] — konkrétní české reputační/faktické selhání.
- [[cesky-rozhlas]] — redakce, která se na testu podílela.

## Výhrady / síla důkazu
- Mediální článek referující o studii (ne primární metodika); samotná opora je studie
  BBC/EBU. České případy jsou lokální ilustrace, ne samostatně silný behaviorální důkaz.
